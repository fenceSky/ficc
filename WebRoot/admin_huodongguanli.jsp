...
<link rel="stylesheet" type="text/css" href="js/extjs/ext-theme-neptune/build/resources/ext-theme-neptune-all.css">
       ...
       <script type="text/javascript" src="js/extjs/ext-theme-neptune/build/ext-theme-neptune.js"></script>
        ...
        <script type ="text/javascript" src="js/app_huodongguanli.js"></script>
	...
	<section class="container">
		<header class="header">
			...
			<ul class="nav">
				...
				<li id="menu-item-7"
					class="menu-item menu-item-type-taxonomy current-menu-item menu-item-object-category menu-item-7"><a
