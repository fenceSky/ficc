...
#submit {
	...
	border-bottom: 2px solid #1e73be;
       ...
       <script type="text/javascript" src="js/extjs/ext-theme-neptune/build/ext-theme-neptune.js"></script>
        ...
        <script type ="text/javascript" src="js/app_huodongshenhe.js"></script>
	...
	<section class="container">
		<header class="header">
			...
			<ul class="nav">
				...
				<li id="menu-item-6"
					class="menu-item menu-item-type-taxonomy current-menu-item menu-item-object-category menu-item-6"><a
					href="<%=basePath %>admin_huodongshenhe.jsp">活动审核</a>
				</li>
				<li id="menu-item-7"
