...
public class ZoomImage {
	...
	public static void main(String args[]) {
		...
		BufferedImage image = ZoomImage.readImage("H:/rwwwx/rwwwx_new/WebRoot/images/photo/irwx_smile.gif");
		System.out.println(image.getWidth());
		System.out.println(image.getHeight());
		
		ZoomImage.reduceImg("H:/rwwwx/rwwwx_new/WebRoot/images/photo/i_03_bg.jpg", "H:/rwwwx/rwwwx_new/WebRoot/images/photo/zoom1.jpg", 400, 200);
