...
public class WpTermTaxonomyDAO extends BaseHibernateDAO {
	...
	public void save(WpTermTaxonomy transientInstance) {
		log.debug("saving WpTermTaxonomy instance");
		try {
	...
	public void update(WpTermTaxonomy transientInstance) {
	...
	public WpTermTaxonomy findById(java.lang.Long id) {
		log.debug("getting WpTermTaxonomy instance with id: " + id);
		try {
			WpTermTaxonomy instance = (WpTermTaxonomy) getSession().get(
					"model.WpTermTaxonomy", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(WpTermTaxonomy instance) {
		...
		try {
			List results = getSession().createCriteria("model.WpTermTaxonomy")
